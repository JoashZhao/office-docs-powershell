...
This policy does not collect, store, or use geographic location data from users’ personal or mobile devices. Any location information used by Teams is derived solely from organization‑managed resources and is used to set the user’s work location within Teams.
